...
import { Grid, Container, Box, Breadcrumbs, Button, Card, CardHeader, Divider, FormControl, InputLabel, MenuItem, Select, Stack, Table, TableBody, TableCell, TableContainer, TableHead, TablePagination, TableRow, Typography, InputAdornment, TextField, Paper } from '@mui/material';
...
function ApplicationsUserBlock() {
  ...
  const handleClickAccept = async (id: number) => {
    try {
      ...
      const res = await APIservice.httpPost('/api/admin/userBlockRequest/updateUserBlockRequest', obj, token, refreshToken);
      getData(0, limit);
              ...
              <Grid item >
                <Stack alignItems="left" justifyContent="space-between">
                  <Breadcrumbs aria-label="breadcrumb">
                    ...
                    <Typography variant="subtitle2" color="inherit" style={{ fontWeight: "bold" }}>Block Users</Typography>
                  </Breadcrumbs>
                </Stack>
              </Grid>
              <Grid item>
                <Grid container spacing={1.5}>
                  <Grid item>
                    <FormControl variant="outlined" fullWidth sx={{ mt: { xs: 0, md: 0 }, width: "none", minWidth: "150px" }}>
                                    ...
                                    return (
                                      ...
                                      >
                                        ...
                                        {(arr.status === null) ? (
                                          <TableCell align="right">
                                            <Box >
                                              <Button size="small" variant="outlined" onClick={(e) => handleClickAccept(arr.id)} sx={{ mt: { xs: 1, md: 0 }, width: "93.38px", }}>Approve</Button>
                                              <Button size="small" variant="outlined" onClick={(e) => handleClickReject(arr.id)} sx={{ mt: { xs: 1, md: 0 }, width: "93.38px", ml: 1 }}>Reject</Button>
                                            </Box>
                                          </TableCell>
                                        ) : (
                                          <TableCell align="right">
