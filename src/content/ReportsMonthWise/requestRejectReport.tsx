...
const ReportReject = () => {
  ...
  const getData = async (currentYear: any) => {
    ...
    if (currentYear) {
      ...
      const res = await APIservice.httpPost('/api/admin/report/getRejectProposalReqReport', obj, token, refreshToken);
            ...
            <Grid item >
              <Stack alignItems="left" justifyContent="space-between" >
                <Breadcrumbs aria-label="breadcrumb">
                  ...
                  <Typography color="inherit" variant="subtitle2" fontWeight="bold">Proposal Request Reject</Typography>
                </Breadcrumbs>
              </Stack>
            </Grid>
            <Grid item>
