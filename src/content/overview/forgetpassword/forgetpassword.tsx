...
import { Card, Container, Grid, Button, Stack, Box, Typography, FormHelperText, IconButton, CardContent, TextField, styled } from '@mui/material';
...
const Forgetpassword = () => {
  ...
  const confirmEmailValidation = (e: any) => {
    ...
    if (value) {
      ...
      setIsEmailError(true);
      setConfirmEmailValidateErrorMsg("Please enter confirm email");
    }
  }
  ...
  const handlesubmit = async (event: any) => {
    ...
    if (flag) {
      try {
        ...
        const res = await APIservice.httpPost('/api/admin/users/forgotPassword', obj);
              ...
              <Card sx={{ borderRadius: "10px" }}>
                <CardContent style={{ padding: "24px" }}>
                  <Form onSubmit={onFormSubmit}>
                    <Typography align="center" fontSize="25px" fontWeight="bolder" className="mb-3">Forgot Password</Typography>
                    <TextField
                      required
                      sx={{ width: "100%", mt: 3 }}
                      type="email"
                      ...
                      onChange={(e: any) => { confirmEmailValidation(e); handleInputChange(e); }}
                    />
